...
[_NUMPAD] = LAYOUT(
  ...
  LLOCK,   KC_LBRC, KC_RBRC, XCASE,   _______, LLOCK,   _______, _______,    _______, _______, KC_EQL,  KC_1,    KC_2,    KC_3,    KC_DOT,  KC_ENT,
                             KC_NO,   _______, _______, _______, _______,    SFT_ENT, KC_0,    TD_HTTP, ENT_HYP, KC_NO
),
...
[_ADJUST] = LAYOUT( \
  ...
  _______, _______, _______, _______, _______, _______,                                         RENC_ADM, RENC_MDP,  RENC_MDM,  RENC_ADP, _______, _______,\
