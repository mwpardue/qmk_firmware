...
combo_t key_combos[] = {
  ...
  const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
      ...
      [_NAVIGATION] = { ENCODER_CCW_CW(TAB_LFT, TAB_RGT),                  ENCODER_CCW_CW(LGUI(KC_MINS), LGUI(KC_EQL)) },
      ...
      [_SYMBOL] =     { ENCODER_CCW_CW(TAB_LFT, TAB_RGT),                  ENCODER_CCW_CW(LGUI(KC_MINS), LGUI(KC_EQL)) },
...
[_COLEMAK_DH] = LAYOUT(
  SM_ESC,  KC_Q,   KC_W,    KC_E,    KC_R,    KC_T,                                            KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    _______,
  CTL_TAB, KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                                            KC_H,    KC_J,    KC_K,    KC_L,    KC_QUOT,    _______,
  PASSPAL, SFT_Z,  KC_X,    KC_C,    KC_V,    KC_B,     UIL_THM, UOL_THM,    UOR_THM, UIR_THM, KC_N,    KC_M,    KC_COMM, KC_DOT,  SFT_QUE, _______,
                            LUTHUM0, LUTHUM1, LUTHUM2,  LIL_THM, CLOL_THM,   LOR_THM, LIR_THM, RUTHUM2, RUTHUM1, KC_NO
),
