...
enum {
    ...
    SFT_TTP, SFT_TTM, BSP_WRD, BSP_LIN, T_CLOSE, SP_RGT, DF_LAYR,
...
// Right thumb keys
    ...
    // Alt Base Thumb Keys
    #define CLOR_THM LT(_HEX,KC_ENTER)
